        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" action="<?= base_url('bank/add') ?>" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="norek" class="form-control" id="norek" placeholder="Nomor Rekening" value="<?= set_value('norek'); ?>">
                    <?= form_error('username', '<small class="text-danger pl-3">', '</small>'); ?>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Atas Nama</label>
                    <input type="text" name="an" class="form-control" id="an" placeholder="Atas Nama" value="<?= set_value('an'); ?>">
