              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <?php $query = "SELECT * FROM master_barang_foto WHERE master_barang_foto.barang_id = " . $m['barang_id'] . " LIMIT 1"; ?>
                    <?php $f = $this->db->query($query)->row_array(); ?>
                    <td><img src="<?= base_url('assets/img/barang/') . $f['barang_foto_file'] ?>" width="100"></td>
                    <td>
